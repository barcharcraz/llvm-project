...
// NOTE: This test has been relaxed somewhat because the stack frames are so different
//       for the debug runtimes.
// CHECK:        operator new
// CHECK:   test_function {{.*}}dll_operator_array_new_left_oob.cpp:[[@LINE-15]]
// CHECK-NEXT:   main {{.*}}dll_host.cpp
// CHECK-LABEL: SUMMARY
  delete [] buffer;
  return 0;
