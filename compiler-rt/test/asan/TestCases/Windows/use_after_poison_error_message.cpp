...
// https://docs.microsoft.com/en-us/cpp/sanitizers/error-use-after-poison
int main(int argc, char **argv) {
  ...
  // CHECK:ERROR: AddressSanitizer: use-after-poison on address [[ADDR:0x[0-9a-f]+]] at pc {{0x[0-9a-f]+}} bp {{0x[0-9a-f]+}} sp {{0x[0-9a-f]+}}
