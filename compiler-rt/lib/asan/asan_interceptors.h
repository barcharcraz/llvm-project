...
#if SANITIZER_WINDOWS
    // Intercept the function `func` only for the provided DLL.
    #define ASAN_INTERCEPT_FUNC_FORDLL(func, dll)                                                         \
      do {                                                                                                \
        if (!__interception::OverrideFunctionForDLL(#func,                                                \
                                                    (::__interception::uptr)WRAP(func##_##dll),           \
                                                    (::__interception::uptr *)&REAL(func##_##dll),        \
                                                    dll,                                                  \
                                                    /* failIfDllNotFound*/ false))                        \
          {                                                                                               \
